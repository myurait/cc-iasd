...
- Project-local install or run is allowed when it stays fully inside the current project context, such as dependency installation that only changes files under the repository root.

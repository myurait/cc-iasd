...
Milestone は roadmap 全体ではない。roadmap 変更は人間判断を必要とする。
...
ledger の evidence は、全情報の複製ではなく、正本成果物への索引である。
...
Completion Report は、milestone 完了時に人間が確認するまとめである。

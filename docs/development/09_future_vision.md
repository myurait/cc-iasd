...
```text
将来像:
- Spec Kit 互換 artifact profile を持つ
- implementation runtime を差し替え可能にする
...
Spec Kit 以外の spec-driven artifact profile を扱う可能性がある。

### 3.2 implementation loop plugin

Claude Code、Codex、独自 shell runner などを差し替える。

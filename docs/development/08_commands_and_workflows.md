...
6. 軽微判断を整理する
7. 残リスクを整理する
8. run-local open item を resolved / escalated / promoted / deferred に分類する
...
3. scope view は指定 id に対応する feature / roadmap / spec / campaign / run と関連 evidence をまとめる
